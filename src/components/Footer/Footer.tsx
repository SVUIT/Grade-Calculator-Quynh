    ...
    <footer className="footer flex flex-col items-center justify-center py-10 gap-6 text-white w-full">
      ...
      <div className="footer-links flex gap-10 text-sm font-bold">
        <a 
          ...
          className="text-white no-underline hover:text-[#711AFF] transition-colors"
          target="_blank" 
          rel="noreferrer"
        >
          Kho tài liệu
      ...
      <a 
        ...
        className="text-white no-underline font-bold text-sm hover:text-[#711AFF] transition-colors"
        target="_blank" 
        rel="noreferrer"
      >
        Báo cáo bug tại đây.
